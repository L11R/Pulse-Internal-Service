...
class Message(models.Model):
	...
	meta = models.CharField(max_length=550, null=True, blank=True, verbose_name="Дополнительные данные")
	order_id = models.CharField(max_length=64, null=True, blank=True, verbose_name="Клиентский номер")
	barcodes = models.CharField(max_length=150, null=True, blank=True, verbose_name="Штрихкоды")
